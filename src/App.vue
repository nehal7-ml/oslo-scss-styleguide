<template>
  ...
  <header class="osg-header">
    ...
    <div class="osg-header__content">
      <div class="osg-none-breakpoint-medium osg-full-height">
        <div class="osg-grid osg-full-height">
          <div class="osg-grid__column--12">
            <div class="osg-full-height osg-flex osg-flex-justify-content-flex-end osg-flex-align-items-center">
              <button class="osg-button osg-none-breakpoint-medium" aria-label="Button text">
      ...
      <div class="osg-none osg-block-breakpoint-medium osg-full-height">
        <div class="osg-grid osg-grid--gap osg-full-height">
          <div class="osg-grid__column--12">
            <div class="osg-full-height osg-flex osg-flex-justify-content-flex-end osg-flex-align-items-center">
              <form class="osg-margin-right-2-breakpoint-medium osg-margin-right-8-breakpoint-large" action method="GET" role="search">
                <div class="osg-search-circle">
                  <div class="osg-search-circle__wrapper">
                    <input class="osg-search-circle__input" type="search" autocomplete="off" aria-label="Label text" placeholder="Search keyword">
                  </div>
                  <button class="osg-search-circle__button" type="submit">
                    <span class="osg-search-circle__button-icon"></span>
...
<style lang="scss">
@import url('https://ukeweb-styleguide-cdn.s3.eu-central-1.amazonaws.com/0.99.105/osg.css');
#app {
